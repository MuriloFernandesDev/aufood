   ...
   return (
      <>
         ...
         <div className="max-w-container mx-auto px-4 mb-10">
            <header className="relative m-auto mt-20 pt-4">
               <div
                  className="flex relative rounded-[4px] h-[250px] items-center w-full text-[#f7f7f7] justify-center bg-cover bg-center bg-no-repeat"
                  style={{
                     backgroundImage:
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center w-full my-10 text-secondary">
