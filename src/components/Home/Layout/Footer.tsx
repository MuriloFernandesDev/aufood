...
const Footer = () => {
   return (
      <footer className="footer flex flex-col py-10 px-4 bg-primary-home text-base-100-home">
         <footer className="footer max-w-container mx-auto px-4">
            ...
            <div>
               ...
               <div className="grid grid-flow-col gap-4">
                  <a href={infoApp.social_networks.twitter} target="__blank">
                     <svg
                  ...
                  <a href={infoApp.social_networks.youtube} target="__blank">
                     <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  <a href={infoApp.social_networks.facebook} target="__blank">
                     <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-2 items-center md:col-span-4">
               ...
               <div className="flex flex-col text-start items-start gap-2">
                  <span className="text-sm text-base-300">
                     ...
                     reservados {infoApp.name} com Agência de Restaurantes
                     Online S.A.
                  </span>
                  <span className="text-sm text-base-300">
                     CNPJ {infoApp.cnpj} / {infoApp.address.street}, nº{' '}
                     {infoApp.address.number}, {infoApp.address.street},{' '}
                     {infoApp.address.city}/{infoApp.address.state} - CEP{' '}
